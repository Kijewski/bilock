...
- Don't use `UnsafeCell<T>` needlessly,
  so `impl<T> RefUnwindSafe for Bilock<T> where T: RefUnwindSafe` is automatically derived
...
[v0.1.2]: <https://github.com/Kijewski/bilock/releases/tag/v0.1.2>
